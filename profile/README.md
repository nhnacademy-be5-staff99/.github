...
### Logging
![image](https://github.com/nhnacademy-be5-staff99/.github/assets/86106442/339df82c-8740-45dd-a643-67a29695ac17)
...
## 송진규
### 태그
- 태그 관리자 화면 구현 및 태그 생성, 조회, 수정, 삭제 구현
- 태그 검색 
### 포인트(진행중)
- 포인트 적립 정책 구현 및 soft delete 적용
...
### 기타
- 템플릿 정하기
- Thymeleaf layout dialect를 이용한 화면 공통화
- 도서, 카테고리, 저자 데이터 삽입
